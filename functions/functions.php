<?php
  ...
  function get_posts1(){
    ...
    $run_posts=mysqli_query($con,$get_posts);
    $get_group="select * from groups where group_id=1";
    $run_group=mysqli_query($con,$get_group);
    $group_name;
    while($row_groups=mysqli_fetch_array($run_group)){
    ...
    while($row_posts=mysqli_fetch_array($run_posts)){
      ...
      echo " <div id='posts'>
      <p><img src='user/user_images/$user_image' width='50' height='50'></p>
      <h3><a href='user_profile.php?user_id=$user_id' >$user_name</a> to $group_name</h3>
      <h4>$post_title</h4>
      <p>$post_date</p>
      <p>$content</p>
